...
@HippoEssentialsGenerated(internalName = "aaadegrees:contentdocument")
@Node(jcrType = "aaadegrees:contentdocument")
public class ContentDocument extends BaseDocument {
    ...
    @HippoEssentialsGenerated(internalName = "aaadegrees:publicationdate")
    public Calendar getPublicationDate() {
        return getProperty("aaadegrees:publicationdate");
    }
}
