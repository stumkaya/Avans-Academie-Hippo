...
@HippoEssentialsGenerated(internalName = "aaadegrees:newsdocument")
@Node(jcrType="aaadegrees:newsdocument")
public class NewsDocument extends HippoDocument {

    /**
     * The document type of the news document.
     */
    public final static String DOCUMENT_TYPE = "aaadegrees:newsdocument";
    ...
    private final static String AUTHOR = "aaadegrees:author";
    private final static String SOURCE = "aaadegrees:source";
     ...
     * @return the author
     */
    @HippoEssentialsGenerated(internalName = "aaadegrees:author")
     ...
     * @return the source
     */
    @HippoEssentialsGenerated(internalName = "aaadegrees:source")
