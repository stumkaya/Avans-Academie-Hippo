...
<#if document??>
<div class="component-hero" data-image="<@hst.link hippobean=document.image/>" data-image-xs="<@hst.link hippobean=document.imagemobile/>">
  <div class="container">
      ...
      <div class="col-xs-12 col-md-4">
        ...
        <div>
          ...
          <ul class="link-list white">
            ...
            <li><#if document.linkurl??><a href="${document.linkurl}">Direct aanmelden</a></#if></li>
          </ul>
        </div>
      </div>
    </div>
